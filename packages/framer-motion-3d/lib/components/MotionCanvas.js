...
function CanvasComponent(_a, forwardedRef) {
    ...
    if (size.width > 0 && size.height > 0) {
        ...
        root.current.configure(__assign(__assign({}, props), { dpr: dpr || props.dpr, size: __assign(__assign({}, size), { top: 0, left: 0 }), events: events || createPointerEvents })).render(React.createElement(ErrorBoundary, { set: setError },
